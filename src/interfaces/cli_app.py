...
def analyze_portfolio(csv_file):
    ...
    logger.info(f"Starting portfolio analysis for file: {csv_file}")
...
def scan_options(csv_file):
    ...
    logger.info(f"Starting options scan for file: {csv_file}")
    portfolio = Portfolio.from_csv(csv_file)
    data_client = MarketDataClient()
...
def advanced_transactions(csv_file):
    ...
    logger.info(f"Starting advanced transaction analysis for file: {csv_file}")
