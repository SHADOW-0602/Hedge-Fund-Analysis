...
class DetailedXIRRAnalyzer:
    ...
    def load_transactions(self, transactions_data):
        ...
        if isinstance(transactions_data, pd.DataFrame):
            ...
            # List of Transaction objects or dictionaries
    ...
    def calculate_detailed_xirr(self, current_prices: Dict[str, float], 
        ...
        return XIRRMetrics(
            xirr=clean_value(xirr),
            twr=clean_value(twr),
            mwr=clean_value(mwr),
            total_return=clean_value(total_return),
            total_return_pct=clean_value(total_return_pct),
            annualized_return=clean_value(annualized_return),
            ...
            profit_factor=clean_value(profit_factor),
            average_win=clean_value(average_win),
            average_loss=clean_value(average_loss),
            largest_win=clean_value(largest_win),
            largest_loss=clean_value(largest_loss),
