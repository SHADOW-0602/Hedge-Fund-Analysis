        ...
        <div id="drawdownSettings" class="settings-panel hidden mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    ...
                    <select id="drawdownPeriod" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white" onchange="updateDrawdownAnalysis()">
                ...
                <div>
                    ...
                    <select id="drawdownFrequency" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white" onchange="updateDrawdownAnalysis()">
                ...
                <div>
                    ...
                    <select id="drawdownSeverity" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white" onchange="updateDrawdownAnalysis()">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Comparison</label>
                    <select id="drawdownComparison" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white" onchange="updateDrawdownAnalysis()">
            ...
            <div class="details-box">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Mild (&lt;5%)</p>
                    </div>
                    <div class="text-center">
                        <p class="text-lg font-semibold text-yellow-600">${severityBreakdown['5-10%'] || 0}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Moderate (5-10%)</p>
                    </div>
                    <div class="text-center">
                        <p class="text-lg font-semibold text-orange-600">${severityBreakdown['10-20%'] || 0}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Severe (10-20%)</p>
                    </div>
                    <div class="text-center">
                        <p class="text-lg font-semibold text-red-600">${severityBreakdown['>20%'] || 0}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Extreme (&gt;20%)</p>
                    </div>
                </div>
            </div>
