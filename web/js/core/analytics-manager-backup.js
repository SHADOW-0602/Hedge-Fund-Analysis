            ...
            <div id="riskSettings" class="settings-panel hidden mb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    <div>
                        ...
                        <select id="riskPeriod" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
                    ...
                    <div>
                        ...
                        <select id="riskVarConfidence" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
                    ...
                    <div>
                        ...
                        <select id="riskModel" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
                    ...
                    <div>
                        ...
                        <select id="riskBenchmark" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
                            <option value="SPY" selected>S&P 500</option>
                    ...
                    <div>
                        ...
                        <select id="riskRollingWindow" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
                            <option value="30">30 days</option>
                            <option value="60">60 days</option>
                            <option value="90">90 days</option>
                            <option value="252" selected>252 days</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="details-box">
                        ...
                        <p class="text-2xl font-bold metric-value neutral">${window.analyticsCore.formatCurrency(metrics.portfolio_value || 0)}</p>
                    </div>
                    <div class="details-box">
                        <h4 class="section-header">Positions</h4>
                        <p class="text-2xl font-bold metric-value neutral">${metrics.num_positions || 0}</p>
                    </div>
                    <div class="details-box">
                        <h4 class="section-header">Symbols Analyzed</h4>
                        <p class="text-2xl font-bold metric-value neutral">${metrics.symbols_analyzed?.length || 0}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-3">
                        ...
                        <div class="metric-row">
                            ...
                            <span class="metric-value ${(metrics.portfolio_volatility || 0) > 0.3 ? 'negative' : 'neutral'}">${window.analyticsCore.formatPercent(metrics.portfolio_volatility || 0)}</span>
                        </div>
                        <div class="metric-row">
                            <span class="metric-label">VaR (${((metrics.var_confidence || 0.95) * 100).toFixed(0)}%)</span>
                        ...
                        <div class="metric-row">
                            <span class="metric-label">CVaR (${((metrics.var_confidence || 0.95) * 100).toFixed(0)}%)</span>
                        ...
                        <div class="metric-row">
                            ...
                            <span class="metric-value negative">${window.analyticsCore.formatPercent(Math.abs(metrics.max_drawdown || 0))}</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="metric-row">
                            ...
                            <span class="metric-value ${(metrics.sortino_ratio || 0) > 1 ? 'positive' : (metrics.sortino_ratio || 0) > 0 ? 'neutral' : 'negative'}">${window.analyticsCore.formatNumber(metrics.sortino_ratio || 0)}</span>
                        </div>
                        <div class="metric-row">
                            <span class="metric-label">Beta (vs ${metrics.benchmark || 'SPY'})</span>
                            <span class="metric-value ${(metrics.beta || 0) > 1.2 ? 'negative' : (metrics.beta || 0) < 0.8 ? 'positive' : 'neutral'}">${window.analyticsCore.formatNumber(metrics.beta || 0)}</span>
                        </div>
                        <div class="metric-row">
                            <span class="metric-label">Tracking Error</span>
                            <span class="metric-value neutral">${window.analyticsCore.formatPercent(metrics.tracking_error || 0)}</span>
                        </div>
                    </div>
                </div>
                
                <!-- Correlation Analysis -->
                ${metrics.avg_correlation !== undefined ? `
                    <div class="details-box">
                        <h4 class="section-header">Correlation Analysis</h4>
                        <div class="metric-row">
                            <span class="metric-label">Average Correlation</span>
                            <span class="metric-value ${(metrics.avg_correlation || 0) > 0.7 ? 'negative' : (metrics.avg_correlation || 0) > 0.3 ? 'neutral' : 'positive'}">${window.analyticsCore.formatNumber(metrics.avg_correlation || 0)}</span>
                        </div>
                    </div>
                ` : ''}
                
                <!-- Risk Contribution -->
                ${Object.keys(metrics.risk_contribution || {}).length > 0 ? `
                    <div class="details-box">
                        ...
                        <div class="space-y-2">
                            ${Object.entries(metrics.risk_contribution || {}).slice(0, 10).map(([symbol, contribution]) => `
                                <div class="metric-row">
                                    ...
                                    <span class="metric-value neutral">${window.analyticsCore.formatPercent(contribution || 0)}</span>
                                </div>
                            `).join('')}
                        </div>
                    </div>
                ...
                <div class="details-box">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div><span class="detail-label">Period:</span> <span class="detail-value">${options?.period || metrics.period || '1Y'}</span></div>
                        <div><span class="detail-label">Risk Model:</span> <span class="detail-value">${metrics.risk_model || options?.risk_model || 'Historical'}</span></div>
                        <div><span class="detail-label">Benchmark:</span> <span class="detail-value">${metrics.benchmark || options?.benchmark || 'SPY'}</span></div>
                        <div><span class="detail-label">Window:</span> <span class="detail-value">${metrics.rolling_window || options?.rolling_window || 252} days</span></div>
                    </div>
                </div>
            </div>
        `;
    ...
    displayOptionsStrategies(result, options) {
        ...
        container.innerHTML = `
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center space-x-2">
                    <select id="strategyFilter" onchange="filterOptionsStrategies()" class="px-3 py-1 border rounded-lg text-sm">
    ...
    displayPerformanceAttribution(result, options) {
        ...
        setTimeout(() => {
            document.querySelectorAll('*').forEach(el => {
                if (el.textContent && el.textContent.includes('Loading performance attribution') && el.offsetHeight < 200) {
                    el.remove();
                }
            });
        }, 100);
        ...
        // Convert percentage values (backend returns as percentages, not decimals)
        const assetAllocation = (attribution.asset_allocation || 0) / 100;
        const securitySelection = (attribution.security_selection || 0) / 100;
        const interactionEffect = (attribution.interaction_effect || 0) / 100;
        const portfolioReturn = (attribution.portfolio_return || 0) / 100;
        const benchmarkReturn = (attribution.benchmark_return || 0) / 100;
        const activeReturn = (attribution.active_return || 0) / 100;
        
        container.innerHTML += `
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-3">
                    <div class="flex justify-between"><span class="text-gray-700">Asset Allocation</span><span class="font-semibold text-blue-600">${window.analyticsCore.formatPercent(assetAllocation)}</span></div>
                    <div class="flex justify-between"><span class="text-gray-700">Security Selection</span><span class="font-semibold text-green-600">${window.analyticsCore.formatPercent(securitySelection)}</span></div>
                    <div class="flex justify-between"><span class="text-gray-700">Interaction Effect</span><span class="font-semibold text-purple-600">${window.analyticsCore.formatPercent(interactionEffect)}</span></div>
                </div>
                <div class="space-y-3">
                    <div class="flex justify-between"><span class="text-gray-700">Total Attribution</span><span class="font-semibold text-gray-900">${window.analyticsCore.formatPercent(activeReturn)}</span></div>
                    <div class="flex justify-between"><span class="text-gray-700">Benchmark Return</span><span class="font-semibold text-gray-600">${window.analyticsCore.formatPercent(benchmarkReturn)}</span></div>
                    <div class="flex justify-between"><span class="text-gray-700">Active Return</span><span class="font-semibold text-indigo-600">${window.analyticsCore.formatPercent(activeReturn)}</span></div>
                </div>
            </div>
        `;
    }
...
window.updateRiskAnalysis = () => {
    ...
    const varConfidence = parseFloat(document.getElementById('riskVarConfidence')?.value || '0.95');
    const riskModel = document.getElementById('riskModel')?.value || 'historical';
    const benchmark = document.getElementById('riskBenchmark')?.value || 'SPY';
    const rollingWindow = parseInt(document.getElementById('riskRollingWindow')?.value || '252');
